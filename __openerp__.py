{
    ...
    'depends': ['theme_common', 'snippet_google_map', 'website_animate', 'snippet_latest_posts', 'latest_posts_esteteatro', 'website_event_snippet_calendar', 'website_event_excerpt_img'],
    'price': 199,
    'currency': 'EUR',
